window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var FIELDS = [
      ...
      { key: "retryableStatuses", kind: "csvNumber", label: "连接类 HTTP 状态码", hint: "逗号分隔或 JSON 数组，如 502, 503, 504" },
      { key: "retryableMessagePatterns", kind: "csv", label: "按消息关键词匹配", hint: "逗号分隔；错误消息包含任一关键词即判定为连接类" },
