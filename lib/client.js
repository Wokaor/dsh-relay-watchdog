window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var FIELDS = [
      ...
      { key: "retryableStatuses", kind: "csvNumber", label: "连接类 HTTP 状态码", hint: "逗号分隔或 JSON 数组，如 500, 502, 503, 504" },
      { key: "retryableMessagePatterns", kind: "csv", label: "按消息关键词匹配", hint: "逗号分隔；默认含 upstream / temporarily unavailable / rate limit exceeded，覆盖上游裸错误文本（如 pi-ai 的 PI_AI_ERROR）" },
